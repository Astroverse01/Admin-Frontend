...
import { astroProblemsAPI } from '../services/api';
import { ChevronLeft, ChevronRight, X, RefreshCw } from 'lucide-react';

const AstroGeneralComplaints = () => {
  ...
  const fetchComplaints = async () => {
    setLoading(true);
    try {
      const response = await astroProblemsAPI.listAstroGeneralComplaints({
  ...
  return (
    <div>
      <div className="mb-6 flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-gray-800">Astro General Complaints</h1>
          <p className="text-gray-600 mt-2">Manage general complaints from astrologers</p>
        </div>
        <button
...
export default AstroGeneralComplaints;
